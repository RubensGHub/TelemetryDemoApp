...
| **Scalabilité**               | Haute scalabilité horizontale avec Grafana Mimir. | Scalabilité verticale limitée, solutions tierces nécessaires pour l’horizontale. | Haute scalabilité horizontale avec InfluxDB Enterprise et clustering. |
